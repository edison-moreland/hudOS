workspace(name = "com_github_edison_moreland_nreal_hud")
...
git_repository(
    ...
    #    branch = "add_meson_support_setup_options",
    commit = "f2b7d431530678808115c55ed1b4ee779fc1f5ba",
    remote = "https://github.com/edison-moreland/rules_foreign_cc.git",
)
